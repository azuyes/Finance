...
public class RecruitController {
	...
	public Result findRecommend(){
		//1.获取结果集
		List<Recruit> recruits = recruitService.findTop4ByStateOrderByCreatetimeDesc();
		//2.创建并返回结果对象
	...
	public Result findNewList(){
		//1.获取结果集
		List<Recruit> recruits = recruitService.findTop12ByStateNotOrderByCreatetimeDesc();
		//2.创建并返回结果对象
		return new Result(true,StatusCode.OK,"查询成功",recruits);
	}
